...
public class SD09_LinkedList {
	...
	public void the_user_clicks_try_here_button_on_links_in_linked_list_page(String string) {
		...
		if (string.equals("Introduction")) {
			...
			WebElement inputLabel = driver.findElement(
					By.xpath("/html/body/div/div/form/div/div/div[6]/div[1]/div/div/div/div[5]/div/div/div"));
	...
	public void the_user_enter_python_code_with_syntax_in_try_editor_in_from_config_properties_in_linked_list_page(
